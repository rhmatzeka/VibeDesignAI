  ...
  return (
    <header className="sticky top-4 z-30 mb-5 rounded-lg border border-[#1f1f1f] bg-[#0c0c0e] px-4 py-3">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <div className="flex items-center gap-3 select-none cursor-default" onDoubleClick={onTitleDoubleClick} title="Double click to access admin">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {adminMode && (
            <>
              ...
              <TopButton 
                icon={<span className="h-2 w-2 rounded-full bg-[#d45656]" />} 
                label="Lock Admin" 
