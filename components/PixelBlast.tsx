...
export default function PixelBlast({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      if (threeRef.current) disposeThree(threeRef.current, container);
      ...
      if (noiseAmount > 0) {
        ...
        const noiseEffect = new Effect(
          ...
          { uniforms: new Map<string, THREE.Uniform<any>>([["uTime", new THREE.Uniform(0)], ["uAmount", new THREE.Uniform(noiseAmount)]]) }
        );
...
function disposeThree(t: any, container: HTMLDivElement) {
